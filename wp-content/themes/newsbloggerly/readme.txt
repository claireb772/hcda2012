...
Newsbloggerly WordPress Theme, Copyright 2021 ThemeEverest
Newsbloggerly is distributed under the terms of the GNU GPL
All files coded by me, and fonts (for example Newsbloggerly font) is under GPLv2 http://www.gnu.org/licenses/gpl-2.0.html

Newsbloggerly bundles the following third-party resources:
...
* IMG FROM SCREENSHOT AND THEME FOLDER
	...
	* Source: https://pxhere.com/en/photo/81346	
	* Image for theme screenshot, Copyright Pxhere
	* License: CC0 1.0 Universal (CC0 1.0)
...
* Font: Newsbloggerly Fonts (customizable-blogily can be found in /fonts)
	* License: SIL OFL 1.1
	* License: CC0 License
